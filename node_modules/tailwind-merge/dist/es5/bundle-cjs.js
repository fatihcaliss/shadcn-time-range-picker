...
var mergeClassList = function mergeClassList(classList, configUtils) {
  ...
  var result = '';
  for (var i = classList.length - 1; i >= 0;) {
    while (classList[i] === ' ') {
      --i;
    }
    var nextI = classList.lastIndexOf(' ', i);
    var originalClassName = classList.slice(nextI === -1 ? 0 : nextI + 1, i + 1);
    i = nextI;
    ...
    for (var _i = 0; _i < conflictGroups.length; ++_i) {
      var group = conflictGroups[_i];
